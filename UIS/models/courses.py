...
class PeriodCourse(UISBaseModel):
    ...
    section_types = models.ManyToManyField('SectionType',
                                           through='PeriodCourseSectionType')
...
class PeriodCourseSectionType(UISBaseModel):
    """
...
class SectionType(MultilingualModel, UISBaseModel):
    """
...
class Section(MultilingualModel, UISBaseModel):
    """
    ...
    #     return (self.course.natural_key(),) + self.group
