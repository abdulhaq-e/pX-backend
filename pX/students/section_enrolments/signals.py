...
def connect_section_enrolment_signals():

    signals.post_save.connect(signal_handlers.on_save_section_enrolment,
                              sender="section_enrolments.SectionEnrolment",
                              dispatch_uid="section_enrolment_saved")


def disconnect_section_enrolment_signals():
    signals.post_save.disconnect(sender="section_enrolments.SectionEnrolment",
                                 dispatch_uid="section_enrolment_saved")
 ...
 # @receiver(pre_save, sender=SectionEnrolment)
