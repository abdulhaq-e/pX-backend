...
class PeriodDegree(pXBaseModel):
    """"""
    period_degree_id = models.UUIDField(primary_key=True,
                                        default=uuid.uuid4,
                                        editable=False)
    period = models.ForeignKey('periods.Period', on_delete=models.PROTECT)
    degree = models.ForeignKey('degrees.Degree', on_delete=models.PROTECT)
